...
import com.polarrose.xmlrpc.util.Base64;
 ...
 *  of objects. @see the com.polarrose.xmlrpc.serializers .
 *
...
public class XmlRpcSerializer
{
    ...
    public XmlRpcSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.polarrose.xmlrpc.serializers.MapSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.ListSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.CollectionSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.ObjectArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.IntArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.FloatArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.DoubleArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.BooleanArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.IntrospectingSerializer() );
        }
    }

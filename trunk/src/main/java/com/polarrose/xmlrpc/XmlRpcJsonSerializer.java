 ...
 *  collections and other types of objects. @see the com.polarrose.xmlrpc.serializers.json .
 *
...
public class XmlRpcJsonSerializer extends XmlRpcSerializer
{
    ...
    public XmlRpcJsonSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.MapSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.ListSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.CollectionSerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.ObjectArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.IntArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.FloatArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.DoubleArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.BooleanArraySerializer() );
            customSerializers.add( new com.polarrose.xmlrpc.serializers.json.IntrospectingSerializer() );
        }
    }
